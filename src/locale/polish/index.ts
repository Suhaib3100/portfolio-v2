export const data = {
  navbar: {
    ...
    linkedin: {
      ...
      image: "/linkedin.png",
      link: "https://www.linkedin.com/in/suhaib-sz/",
      dateText: "Joined December 2022",
    },
    contact: {
      slug: "Contact",
      title: "Contact",
  ...
  hero: {
    ...
    description:
      "Hi! I'm Suhaib, a skilled Fullstack Next.js Developer based in India. With a passion for transforming innovative ideas into efficient and engaging web applications, I specialize in delivering robust solutions that drive success.",
  ...
  projects: {
    ...
    projects: [
      {
        id: 1,
        title: "Erasor - Editor with Canvas",
        description:
          "Erasor is an innovative project that uses artificial intelligence . From taking simple notes to providing intelligent insights based on their context. Create notes containing valuable information also the editing canvas that the AI will analyze and use its context to create its own answers. If answering questions based on the context of your notes isn't enough, query the OpenAI model directly.",
      ...
      {
        id: 2,
        title: "Video Conferncing App",
        description:
          "ZoomClone is a cutting-edge video conferencing app designed to revolutionize virtual communication. It offers seamless, high-quality video and audio meetings, allowing users to connect with colleagues, friends, and family from anywhere in the world. With features like real-time screen sharing, interactive whiteboards, and breakout rooms, ZoomClone enhances collaboration and productivity. Advanced security protocols ensure all communications remain private and secure. Whether for business meetings, online classes, or social gatherings, ZoomClone provides a reliable and user-friendly platform for all your virtual interaction needs.",
        img: "/p2.svg",
        iconLists: [
          {
            title: "NEXT.JS",
        ...
        linkText: "Experience the Platform",
        link: "https://github.com/Suhaib3100/pro-meet",
      },
      {
        id: 3,
        title: "Protool Agency",
        description:
          "Protool is a leading web and app development company dedicated to creating innovative and tailored digital solutions for businesses of all sizes. With a team of expert developers, designers, and strategists, Protool delivers high-quality websites and mobile applications that enhance user experience and drive business growth. Specializing in cutting-edge technologies and agile methodologies, Protool ensures each project is completed with precision and excellence. Whether you're looking to build a robust e-commerce platform, a dynamic corporate website, or a custom mobile app, Protool has the expertise and passion to bring your vision to life.",
        img: "/image.png",
        iconLists: [
          {
            title: "NEXT.JS",
      ...
      },
      {
        ...
        title: "Plura",
        description:
          "Plura is a FullStack SaaS platform where users can perform multiple tasks, including building their websites in minutes. It provides a user-friendly interface and powerful tools that enable businesses to create, manage, and scale their online presence effortlessly. Plura offers a variety of customizable templates, integrated analytics, and seamless deployment options, making it the perfect solution for entrepreneurs and enterprises looking to enhance their digital footprint.",
        img: "/plura.png",
        iconLists: [
          {
            title: "NEXT.JS",
        ...
        linkText: "Check the Repositpry",
        link: "https://github.com/Suhaib3100/plura",
      },
    ],
  },
  ...
  footer: {
    ...
    faq: "Look at FAQ",
    autograph: "Handcrafted by Suhaib @ 2024",
  },
